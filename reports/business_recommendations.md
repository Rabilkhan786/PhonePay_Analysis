...
Full supporting metrics, alternative ranks, and recommendations are in `data/processed/analysis/top10_recommendations.csv`.
...
Source: [Official PhonePe Pulse repository](https://github.com/PhonePe/pulse/tree/943e6e52a71513d683f804add12d0b61145e8007). Computation: `sql/03_core_analysis.sql`, `sql/04_growth_analysis.sql`, `sql/05_opportunity_analysis.sql`, and `src/phonepe_analytics/analysis.py`.
